...
export default function Comparison() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-8">
      <Link to="/literary?id=2" className="back-btn" aria-label="Back to literary work">← Back to Romeo and Juliet</Link>
      ...
      <div className="grid grid-cols-2 gap-4">
        <section className="bg-surface rounded-card overflow-hidden border border-white/4">
        ...
        <section className="bg-surface rounded-card overflow-hidden border border-white/4">
          ...
          <div className="p-5 max-h-140 overflow-y-auto [&_p]:text-sm [&_p]:text-text2 [&_p]:leading-relaxed [&_p]:mb-3 [&_h3]:text-teal [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-base">
            <div className="player-placeholder">
              <div className="play-btn" role="button" tabIndex={0} aria-label="Play opening scene excerpt">▶</div>
            ...
            <h2 className="text-sm font-semibold mb-3 font-sans">💬 Critiques & Analysis</h2>
            <div className="flex gap-3 mb-3">
              <div className="comment-avatar bg-teal" aria-hidden>M</div>
            ...
            <div className="flex gap-3 mb-3">
              <div className="comment-avatar bg-blue" aria-hidden>J</div>
            ...
            <div className="flex gap-3 mb-3">
              <div className="comment-avatar bg-mauve" aria-hidden>A</div>
            ...
            <div className="flex gap-2 mt-3" role="form" aria-label="Add a critique">
              <input
                type="text"
              ...
              />
              <button className="btn-teal btn-circle" onClick={handleCommentSubmit} aria-label="Submit critique">＋</button>
            </div>
          </div>
        </section>
      </div>
